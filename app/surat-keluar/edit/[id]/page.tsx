...
export default function EditSuratKeluar() {
  ...
  useEffect(() => {
    const fetchSurat = async () => {
      try {
        // Mengambil data dari endpoint surat-keluar
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    if (res.ok) { 
      alert("Perubahan Arsip Surat Keluar Berhasil Disimpan!"); 
  ...
  if (fetching) return <div style={{ padding: '4rem', textAlign: 'center', color: '#800000', fontWeight: 800 }}>MENGAMBIL DATA ARSIP SURAT KELUAR...</div>;
    ...
    <div className="page-wrapper" style={{ 
      ...
      <div className="form-card" style={{
        ...
        <div style={{ padding: '1.8rem 2.5rem', borderBottom: '1px solid #f1f5f9', display: 'flex', alignItems: 'center', gap: '15px' }}>
          ...
          <h2 style={{ fontWeight: 900, color: '#1e293b', fontSize: '1.3rem', margin: 0 }}>EDIT DATA SURAT KELUAR</h2>
        </div>
        ...
        <form onSubmit={handleSubmit}>
          <div style={{ padding: '2.5rem', display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1.8rem' }}>
            ...
            <div style={{ gridColumn: 'span 2' }}>
              ...
              <input name="tujuanSurat" required defaultValue={formData.tujuanSurat} style={inputStyle} />
            </div>
          ...
          <div style={{ padding: '2rem 2.5rem', background: '#f8fafc', borderTop: '1px solid #f1f5f9', textAlign: 'center' }}>
            ...
            >
              {loading ? "MENYIMPAN PERUBAHAN..." : "UPDATE DATA ARSIP KELUAR"}
            </button>
          </div>
        </form>
      </div>
