...
export default function TambahSuratMasuk() {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    // Menggunakan metode POST untuk menyimpan data baru ke database melalui API surat-masuk
    ...
    if (res.ok) { 
      alert("Arsip Surat Masuk Berhasil Ditambahkan!"); 
      router.push("/surat-masuk"); 
      router.refresh();
    } else {
      alert("Gagal menambahkan data. Pastikan semua field wajib terisi dengan benar.");
    }
    setLoading(false);
  };
      ...
      <div className="form-card" style={{
        ...
        <form onSubmit={handleSubmit}>
          <div className="form-body" style={{
            ...
            {/* Field Alamat Pengirim (Full Width) */}
            <div className="input-group full-width" style={{ gridColumn: 'span 2' }}>
              <label style={{ display: 'block', fontSize: '0.8rem', fontWeight: 800, color: '#475569', marginBottom: '10px', textTransform: 'uppercase' }}>Alamat Pengirim</label>
              <input name="alamatPengirim" required placeholder="Masukkan alamat atau instansi pengirim" style={{ width: '100%', padding: '14px 18px', border: '1.5px solid #e2e8f0', borderRadius: '12px', fontSize: '0.95rem', background: '#f8fafc' }} />
            </div>
            ...
            <div className="input-group">
              ...
              <input name="nomorSurat" required placeholder="Masukkan nomor surat dari pengirim" style={{ width: '100%', padding: '14px 18px', border: '1.5px solid #e2e8f0', borderRadius: '12px', fontSize: '0.95rem', background: '#f8fafc' }} />
            </div>
            ...
            <div className="input-group">
              ...
              <input name="noPetunjuk" placeholder="Masukkan nomor petunjuk" style={{ width: '100%', padding: '14px 18px', border: '1.5px solid #e2e8f0', borderRadius: '12px', fontSize: '0.95rem', background: '#f8fafc' }} />
            </div>
            ...
            <div className="input-group">
              ...
              <input name="noPaket" placeholder="Masukkan nomor paket" style={{ width: '100%', padding: '14px 18px', border: '1.5px solid #e2e8f0', borderRadius: '12px', fontSize: '0.95rem', background: '#f8fafc' }} />
            </div>
            ...
            <div className="input-group full-width" style={{ gridColumn: 'span 2' }}>
              ...
              <textarea name="perihal" rows={4} required placeholder="Ringkasan perihal surat masuk..." style={{ width: '100%', padding: '14px 18px', border: '1.5px solid #e2e8f0', borderRadius: '12px', fontSize: '0.95rem', background: '#f8fafc', resize: 'vertical', lineHeight: '1.6' }}></textarea>
            </div>
            ...
            <div className="upload-container" style={{ gridColumn: 'span 2', background: '#fdf2f2', border: '2px dashed #f87171', padding: '2rem', borderRadius: '16px', marginTop: '10px' }}>
              <label style={{ display: 'block', marginBottom: '20px', color: '#800000', fontWeight: 900, fontSize: '0.85rem', textTransform: 'uppercase', textAlign: 'center' }}>
                📎 Unggah Lampiran Digital (Scan Surat) (Opsional)
              </label>
          ...
          <div className="form-footer" style={{ padding: '2rem 2.5rem', background: '#f8fafc', borderTop: '1px solid #f1f5f9', textAlign: 'center' }}>
            ...
            >
              {loading ? "SEDANG MENYIMPAN..." : "SIMPAN ARSIP SURAT MASUK"}
            </button>
          </div>
        </form>
      </div>
