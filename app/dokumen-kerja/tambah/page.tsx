...
export default function TambahDokumenKerja() {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    // Menggunakan metode POST untuk menambah data baru ke endpoint dokumen-kerja
    ...
    if (res.ok) { 
      alert("Dokumen Kerja Berhasil Ditambahkan!"); 
      ...
      <div className="form-card" style={{
        ...
        <form onSubmit={handleSubmit}>
          <div className="form-body" style={{
            ...
            <div className="input-group">
              ...
              <input 
                name="namaDokumen" 
                required 
                placeholder="Masukkan nama atau judul dokumen kerja" 
                style={inputStyle} 
              />
            </div>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1.8rem' }}>
              ...
              <div className="input-group">
                ...
                <input 
                  name="tempat" 
                  required 
                  placeholder="Masukkan lokasi dokumen (contoh: Bojonegoro)" 
                  style={inputStyle} 
                />
              </div>
            </div>
            ...
            <div className="upload-container" style={{ background: '#fdf2f2', border: '2px dashed #f87171', padding: '2rem', borderRadius: '16px', marginTop: '10px' }}>
              <label style={{ display: 'block', marginBottom: '20px', color: '#800000', fontWeight: 900, fontSize: '0.85rem', textTransform: 'uppercase', textAlign: 'center' }}>
                📎 Unggah Berkas Dokumen Kerja (Opsional)
              </label>
          ...
          <div className="form-footer" style={{ padding: '2rem 2.5rem', background: '#f8fafc', borderTop: '1px solid #f1f5f9', textAlign: 'center' }}>
            ...
            >
              {loading ? "SEDANG MENYIMPAN..." : "SIMPAN DATA DOKUMEN KERJA"}
            </button>
          </div>
        </form>
      </div>
